...
namespace ImageTool {
    Image::Image(const char *a_pstrFilename){
        ...
        m_SourceImage = SourceImage(source.FilePath(), GetType(source.FileType()));
    }
    ...
    int Image::Save(const char *a_pstrFilename, Filetype a_efileType, unsigned int a_uiWidth, unsigned int a_uiHeight) {
        m_SourceImage.Encode(a_pstrFilename, a_efileType, a_uiWidth, a_uiHeight);
        return 1;
    }

    int Image::SaveAlign(const char *a_pstrFilename, Filetype a_efileType, unsigned int a_uiHAlignCoef,
    ...
    int Image::SavePreMulAlphaWithAlign(const char *a_pstrFilename, ImageType::Filetype a_efileType,
